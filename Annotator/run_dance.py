...
def main(cli_args):
    ...
    config_filename = "{}.json".format(cli_args.taxonomy) #'EdmondsDance.json'
...
if __name__ == '__main__':
    ...
    cli_parser.add_argument("--taxonomy", type=str, default='EdmondsDance', help="Taxonomy (original, ekman, group)")
    cli_args = cli_parser.parse_args()
    #Namespace(taxonomy='EdmondsDance')
    main(cli_args)